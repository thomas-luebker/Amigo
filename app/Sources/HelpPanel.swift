        ...
        VStack(alignment: .leading, spacing: 8) {
            ...
            ScrollView {
                VStack(alignment: .leading, spacing: 10) {
                    ...
                    row("cable.connector", "Serial Tablet (Input menu): the Pencil becomes a Wacom on the serial port for TVPaint and other programs that drive a tablet directly")
